"""
TODO definitely need to think of something cleverer for the infinite grid
	count steps to the edge, then number of steps from any edge to any edge?
	something dumb and recursive?
